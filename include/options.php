...
Kirki::add_field( 'shamrock_settings', array(
        'type'        => 'radio',
        'settings'    => 'img_size_standard_ratio',
...
Kirki::add_field( 'shamrock_settings', array(
        'type'        => 'text',
        'settings'    => 'img_size_standard_custom',
        'label'       => '',
